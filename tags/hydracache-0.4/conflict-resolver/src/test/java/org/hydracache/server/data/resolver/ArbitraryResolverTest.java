 ...
 */
public class ArbitraryResolverTest extends AbstractResolverTest {

    @Override
    protected ConflictResolver newConflictResolver() {
        return new ArbitraryResolver();
    }
    ...
    @Override
    protected void oneDescendant(final Versioned vs1, final Versioned vs2,
    ...
    @Override
    protected void twoDescendant(final Versioned vs1, final Versioned vs2,
    ...
    @Override
    protected void mixedFirst(final Versioned vs1, final Versioned vs2,
            final Versioned vs3, final ResolutionResult result) {
