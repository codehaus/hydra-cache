...
public class ReliableDataStorageException extends DataStorageException {
    ...
    public ReliableDataStorageException(String message, Throwable cause) {
        super(message, cause);
    }

    public ReliableDataStorageException(String message) {
        super(message);
    }

    public ReliableDataStorageException(Throwable cause) {
        super(cause);
    }
